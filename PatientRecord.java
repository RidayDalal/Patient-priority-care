...
public class PatientRecord implements Comparable<PatientRecord> {
    ...
    public int compareTo(PatientRecord other) {
        ...
        int triageComparison = this.getTriage().compareTo(other.getTriage());
        int orderOfArrivalComparison = this.getArrivalOrder() - other.getArrivalOrder();

        if (triageComparison != 0) {
            return triageComparison;
        } else {
            if (orderOfArrivalComparison != 0) {
                return orderOfArrivalComparison;
            } else {
                return 0;
            }
        }
